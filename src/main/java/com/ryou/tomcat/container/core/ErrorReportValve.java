...
import com.ryou.tomcat.utils.Escape;
...
//        InputStream resourceAsStream = ErrorReportValve.class.getClassLoader().getResourceAsStream("http-code-reason.properties");
        try (InputStream resourceAsStream = cl.getResourceAsStream("http-code-reason.properties")) {
//            System.out.println(resourceAsStream);
            httpCodeReasons.load(resourceAsStream);
        } catch (IOException e) {
            e.printStackTrace();
        }*/
